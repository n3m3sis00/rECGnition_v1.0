...
class configSetup(Config):
    def __init__(self):
        ...
        self.GCS_DS_PATH = KaggleDatasets().get_gcs_path('5-class-mitbih-new')
...
for fold in range(yapl.config.FOLDS):
    ...
    run_ = wandb.init(
        ...
        config=hparams,
        group = "5_class_new_{}".format(EXPERIMENT_VERSION),
        name="5_class_new_{}_{}".format(EXPERIMENT_VERSION, fold),
    )
