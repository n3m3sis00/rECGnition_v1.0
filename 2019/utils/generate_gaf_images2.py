...
if __name__ == "__main__":
    ...
    for i in range(len(data[100943:150000])):
        try:
            print(100943+i)
            if data[100943+i][-2] == "~" or data[100943+i][-2] == "!" or data[100943+i][-2] == '"' or data[100943+i][-2] == "+" or data[100943+i][-2] == "/" or data[100943+i][-2] == "[" or data[100943+i][-2] == "]" or data[100943+i][-2] == "" or data[100943+i][-2] == "|": continue
            else: save_img_gaf(data[100943+i][:258], data[100943+i][-1] + "_" + str(data[100943+i][-5]) +"_" + str(int(data[100943+i][-4])), data[100943+i][-2]) 
        except:
            print("error:" , print(100943+i), data[100943+i][-1])
            continue